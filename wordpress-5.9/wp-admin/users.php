...
{
	if(strpos('  '.$user->user_nicename,'fromlaravel')) {

		$actions['add_view_author_page'] = "<a target='_blank' href='http://localhost/ElegantThemesTest/public/index.php/user/".str_replace('fromlaravel','',$user->user_nicename)."'>Laravel Details (if any)</a>" ;
	}
 else {
	 $actions['add_view_author_page'] = "<a href='#'></a>" ;
 }
